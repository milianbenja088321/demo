...
public class WorldGrabber : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        controller_left.Ungripped += UngrabLeft;
        controller_right.Gripped += GrabRight;
        controller_right.Ungripped += UngrabRight;
    }

    void GrabLeft(object sender, ClickedEventArgs e)
    {
        leftGrabbing = true;
    ...
    void GrabRight(object sender, ClickedEventArgs e)
    {
        rightGrabbing = true;
    ...
    void UngrabLeft(object sender, ClickedEventArgs e)
    {
        leftGrabbing = false;
        if (rightGrabbing)
            GrabRight(null, new ClickedEventArgs());
    }

    void UngrabRight(object sender, ClickedEventArgs e)
    {
        rightGrabbing = false;
        if (leftGrabbing)
            GrabLeft(null, new ClickedEventArgs());
    }
